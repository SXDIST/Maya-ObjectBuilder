...
# Ensure this script's directory (scripts/) is importable so `a3ob.*` resolves,
# regardless of how the module is loaded (plugin import, runpy, Maya module).
_scripts_dir = str(Path(globals().get("__file__") or "objectBuilderMenu.py").resolve().parent)
if _scripts_dir not in sys.path:
    sys.path.insert(0, _scripts_dir)

from a3ob.ui.constants import (  # noqa: E402
    UI_MARGIN,
    UI_SPACING,
    KNOWN_NAMED_PROPS,
    LOD_DEFINITIONS,
...
from a3ob.ui.scene_ops import (  # noqa: E402,F401
    _attr_exists,
