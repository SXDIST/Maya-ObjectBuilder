...
from a3ob.mayabridge.commands.skin import SkinWeightsCommand, TransferSkinCommand, TestPoseCommand, ReferenceAssetCommand
...
COMMANDS = [
    ...
    ReferenceAssetCommand, InfluenceCommand,
]

__all__ = [
    "ValidateCommand", "SetMassCommand", "SetMaterialCommand", "SetFlagCommand",
    "FindComponentsCommand", "CreateLODCommand", "ProxyCommand", "NamedPropertyCommand",
    "UpdateProxyCommand", "SkinWeightsCommand", "TransferSkinCommand", "TestPoseCommand", "ReferenceAssetCommand", "InfluenceCommand", "COMMANDS",
]
