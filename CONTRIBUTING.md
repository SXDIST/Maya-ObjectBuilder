...
Edit the Python under `plug-ins/` and `scripts/`, reload the plugin in Maya, and your changes take effect. See `README.md` for the headless variant and `scripts/launch_maya_debug.ps1` for launching Maya with the dev module.
